...
import { getAuth, signInWithPopup, createUserWithEmailAndPassword, signInWithEmailAndPassword } from "https://www.gstatic.com/firebasejs/10.3.0/firebase-auth.js";
...
.catch((error) => {
    ...
    .then((result) => {
        ...
        if (error.code === 'auth/popup-blocked') {
            // Handle popup blocked case, e.g., show a message to the user.
            console.log('Popup blocked by the browser. Please enable popups.');
        } else {
            // Handle other errors.
            console.error(error);
        }
...
function showLoadingScreen() {
    ...
    setTimeout(() => { hideLoadingScreen(); }, 1000*30);
